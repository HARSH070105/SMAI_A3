...
# ==========================================
# 2. Define Classes & Process Custom Ensemble Prompts
# ==========================================
monuments_24 = [
...
print("\nStarting Zero-Shot Custom Ensemble Prompt Benchmarking...")
with torch.no_grad():
...
print("\n" + "="*50)
print("   CUSTOM ENSEMBLE PROMPT RESULTS")
print("="*50)
print(accuracy_str + "\n")
...
report_path = os.path.join(ROOT_DIR, "reports", "custom_ensemble_report_lora.txt")
with open(report_path, "w") as f:
    f.write("=" * 50 + "\n")
    f.write("   CUSTOM ENSEMBLE PROMPT RESULTS\n")
    f.write("=" * 50 + "\n\n")
...
ax.set_title(f"Normalized Confusion Matrix — Custom Ensemble Prompts\n{accuracy_str}", fontsize=14, pad=16)
...
cm_path = os.path.join(ROOT_DIR, "reports", "custom_ensemble_confusion_matrix_lora.png")
