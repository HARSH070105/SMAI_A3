...
EVAL_SCRIPT = os.path.join(ROOT_DIR, "scripts", "evaluation", "evaluate_verification.py")
...
for model in model_types:
    ...
    for prompt in prompt_types:
        print(f"\n{'='*60}")
        print(f"Running Verification Evaluation for Model: {model} | Prompt: {prompt}")
        print(f"{'='*60}\n")
        ...
        try:
            ...
            print(f"Verification Evaluation failed for Model: {model} | Prompt: {prompt}")
            print(f"Error: {e}")

print("\nVerification Matrix Evaluation Complete!")
